...
struct ObIndexUsageKey {
  ObIndexUsageKey(int64_t database_id, int64_t tenant_id,
  ...
  uint64_t hash() const {
    uint64_t hash_value =
        common::murmurhash(&database_id, 3 * sizeof(int64_t), 0);
    return hash_value;
  }
...
struct ObIndexUsageInfo {
  ObIndexUsageInfo(int64_t data_table_id, int64_t ref_count,
...
public:
  typedef common::hash::HashMapPair<const ObIndexUsageKey *, ObIndexUsageInfo *>
      ObIndexUsagePair;
...
public:
  ...
  int update(const int64_t database_id, const int64_t tenant_id,
