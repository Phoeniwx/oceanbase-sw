...
public:
  ...
  static int dba_ob_index_usage_schema(share::schema::ObTableSchema &table_schema);
...
const schema_create_func sys_view_schema_creators [] = {
  ...
  ObInnerTableSchema::dba_ob_index_usage_schema,
...
const int64_t OB_SYS_VIEW_COUNT = 785;
const int64_t OB_SYS_TENANT_TABLE_COUNT = 1785;
const int64_t OB_CORE_SCHEMA_VERSION = 1;
const int64_t OB_BOOTSTRAP_SCHEMA_VERSION = 1788;
