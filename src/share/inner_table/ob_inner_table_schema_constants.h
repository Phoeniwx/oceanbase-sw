...
const uint64_t OB_ALL_INDEX_USAGE_INFO_TID = 487; // "__all_index_usage_info"
...
const uint64_t OB_ALL_INDEX_USAGE_INFO_AUX_LOB_META_TID = 50487; // "__all_index_usage_info_aux_lob_meta"
...
const uint64_t OB_ALL_INDEX_USAGE_INFO_AUX_LOB_PIECE_TID = 60487; // "__all_index_usage_info_aux_lob_piece"
